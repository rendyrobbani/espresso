package com.rendyrobbani.espresso.factory.classify.fungsi;

import com.rendyrobbani.espresso.common.data.classify.fungsi.FungsiClassification;
import com.rendyrobbani.espresso.common.impl.classify.fungsi.FungsiClassificationImpl;
...
public final class FungsiClassificationFactory {
	...
	public static FungsiClassification classify(String code) {
		...
		if (matcher.matches()) return new FungsiClassificationImpl(
				matcher.group(1),
				null,
				FungsiClassificationLevelImpl.FUNGSI
		);

		return null;
	}

	public static FungsiClassification classifyFromKegiatanCode(String code) {
