...
public final class SmallIntColumnFactory {
	...
	private static final ColumnTypeImpl DEFAULT_TYPE = ColumnTypeImpl.SMALLINT;
	...
	public static Column create(String name, boolean isNullable, boolean isPrimaryKey) {
		return ColumnFactory.create(name, DEFAULT_SIZE, DEFAULT_TYPE, isNullable, isPrimaryKey, false);
	}
